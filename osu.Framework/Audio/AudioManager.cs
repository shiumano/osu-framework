...
namespace osu.Framework.Audio
{
    public class AudioManager : AudioCollectionManager<AudioComponent>
    {
        ...
        /// </summary>
        public readonly BindableBool UseExperimentalAAudioExclusive = new BindableBool();
        ...
        public AudioManager(AudioThread audioThread, ResourceStore<byte[]> trackStore, ResourceStore<byte[]> sampleStore, [CanBeNull] FrameworkConfigManager config)
        {
            ...
            if (config != null)
            {
                ...
                config.BindWith(FrameworkSetting.AudioUseExperimentalAAudioExclusive, UseExperimentalAAudioExclusive);
            ...
            UseExperimentalAAudioExclusive.ValueChanged += _ => scheduler.AddOnce(initCurrentDevice);
        ...
        protected virtual bool InitBass(int device)
        {
            ...
            Bass.Configure(ManagedBass.Configuration.AndroidSessionId, UseExperimentalAAudioExclusive.Value ? -1 : 0);
